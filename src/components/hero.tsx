...
export function Hero() {
  ...
  return (
    <section id="hero" className="relative h-screen min-h-[700px] w-full flex items-center justify-center text-white overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center p-4 animate-fade-in-up max-w-3xl mx-auto">
        
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4 font-headline text-white [text-shadow:0_3px_10px_rgba(0,0,0,0.7)]">
